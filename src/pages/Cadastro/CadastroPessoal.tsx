...
//Controller é um componente que permite integrar componentes de terceiros com o react-hook-form
...
const CadastroPessoal = () => {
  //register é um objeto que conecta os inputs ao react-hook-form
  //register: função que registra um input ou select para o gerenciamento do formulário
  ...
  //handleSubmit é uma função de orderm superior que recebe uma função ou pode retornar uma função
